        ...
        <div id="panel_wrapper">
            <section class="panel" id="panel_1">
                <article id="photograph">
                    <button id="dp" onmouseover="document.getElementById('change_dp').style.opacity='0.9';" onmouseout="document.getElementById('change_dp').style.opacity='0';"><div id="change_dp"><span style="display: block; font-size: 4vh; margin-bottom: 0.5vh;"><i class="fa fa-camera"></i></span>Click to update display picture</div></button>
                    <div class="post_name name">Vyom Maitreya</div>
                ...
                <article id="all-events">
                    ...
                    <img class="small-event" src="/assets/images/event_1.jpg" />
            ...
            <section class="panel" id="panel_3">
                <article id="upcoming-events">
                    ...
                    <ul class="upcoming">
                        <li>International Coding League: 1st February</li>
